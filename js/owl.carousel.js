...
(function($, window, document, undefined) {
        ...
        Owl.prototype.onDragStart = function(event) {
            ...
            if (this.is('animating')) {
                $.support.transform ? this.animate(stage.x) : this.$stage.stop() this.invalidate('position');
            }
...
(function($, window, document, undefined) {
        ...
        if (tests.cssanimations()) {
            /* jshint -W053 */
            $.support.animation = new String(prefixed('animation')) $.support.animation.end = events.animation.end[$.support.animation];
        }
